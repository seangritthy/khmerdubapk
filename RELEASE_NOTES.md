...
- **Web Sniffer Browser**: Integrated media sniffer browser for instant stream URL detection.
- **Auto-Updater Engine**: 1-click update checker with HTTP 301/302 redirect support and native package installer launcher.
